Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/1f2fc3949c410344b8c56a6bac6c28c8"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			inline float2 POM(in PoiLight poiLight, sampler2D heightMap, in PoiMesh poiMesh, float3 worldViewDir, float3 viewDirTan, int minSamples, int maxSamples, float parallax, float refPlane, float2 tilling, float2 curv)
			{
				...
				while (stepIndex < numSteps + 1)
				{
					...
					else
					{
						...
						currRayZ -= layerHeight * (1 - result.z) * (1 + (1.0 /*_CurvFix*/));
					}
				}
				int sectionSteps = 10;
				int sectionIndex = 0;
			...
			void applyParallax(inout PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam)
			{
				...
				poiMesh.uv[(0.0 /*_ParallaxUV*/)] = POM(poiLight, _HeightMap, poiMesh, poiCam.viewDir, poiCam.tangentViewDir, (1.0 /*_HeightStepsMin*/), (128.0 /*_HeightStepsMax*/), (0.147 /*_HeightStrength*/), 0, float4(1,1,0,0).xy, float2((0.0 /*_CurvatureU*/), (0.0 /*_CurvatureV*/)));
				#else
				float2 offset = POM(poiLight, _HeightMap, poiMesh, poiCam.viewDir, poiCam.tangentViewDir, (1.0 /*_HeightStepsMin*/), (128.0 /*_HeightStepsMax*/), (0.147 /*_HeightStrength*/), 0, float4(1,1,0,0).xy, float2((0.0 /*_CurvatureU*/), (0.0 /*_CurvatureV*/)));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					mainUV = sharpSample(float4(0.0002441406,0.0004541326,4096,2202), mainUV);
				}
				float4 mainTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_MainTex, _MainTex, mainUV, float4(-0.1,0.3,0,0), (0.0 /*_MainTexStochastic*/));
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,0.04091519,0.2098985,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(1,0.04091519,0.2098985,1).a;
