Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/21abcaa703cf33246a851ac2b5bc4b69"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyParallax(inout PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam)
			{
				...
				poiMesh.uv[(0.0 /*_ParallaxUV*/)] = POM(poiLight, _HeightMap, poiMesh, poiCam.viewDir, poiCam.tangentViewDir, (1.0 /*_HeightStepsMin*/), (128.0 /*_HeightStepsMax*/), (0.075 /*_HeightStrength*/), 0, float4(1,1,0,0).xy, float2((0.0 /*_CurvatureU*/), (0.0 /*_CurvatureV*/)));
				#else
				float2 offset = POM(poiLight, _HeightMap, poiMesh, poiCam.viewDir, poiCam.tangentViewDir, (1.0 /*_HeightStepsMin*/), (128.0 /*_HeightStepsMax*/), (0.075 /*_HeightStrength*/), 0, float4(1,1,0,0).xy, float2((0.0 /*_CurvatureU*/), (0.0 /*_CurvatureV*/)));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					mainUV = sharpSample(float4(0.0002441406,0.0004882813,4096,2048), mainUV);
				}
				float4 mainTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_MainTex, _MainTex, mainUV, float4(0.2,0,0,0), (0.0 /*_MainTexStochastic*/));
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,0,0.1206432,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(1,0,0.1206432,1).a;
