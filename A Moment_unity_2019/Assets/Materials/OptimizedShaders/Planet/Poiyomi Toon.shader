Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/e3206596e19225d47a1eb89f1549f79f"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_HEIGHTMASK) || !defined(OPTIMIZER_ENABLED)
				float heightMask = POI2D_SAMPLER_PAN(_Heightmask, _linear_repeat, poiUV(poiMesh.uv[(0.0 /*_HeightmaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(0.0 /*_HeightmaskChannel*/)];
				if ((0.0 /*_HeightmaskInvert*/))
				{
				...
				float heightMask = 1;
				#endif
				float2 uvs = poiUV(poiMesh.uv[(0.0 /*_HeightMapUV*/)], float4(1,1,0,0));
				float2 dx = ddx(uvs);
				float2 dy = ddy(uvs);
				float3 result = 0;
				int stepIndex = 0;
				...
				while (stepIndex < numSteps + 1)
				{
					...
					else
					{
						...
						currRayZ -= layerHeight * (1 - result.z) * (1 + (0.0 /*_CurvFix*/));
					}
				}
				int sectionSteps = 10;
				int sectionIndex = 0;
			...
			void applyParallax(inout PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam)
			{
				...
				poiMesh.uv[(0.0 /*_ParallaxUV*/)] = POM(poiLight, _HeightMap, poiMesh, poiCam.viewDir, poiCam.tangentViewDir, (1.0 /*_HeightStepsMin*/), (1.0 /*_HeightStepsMax*/), (0.005 /*_HeightStrength*/), 0, float4(1,1,0,0).xy, float2((0.0 /*_CurvatureU*/), (0.0 /*_CurvatureV*/)));
				#else
				float2 offset = POM(poiLight, _HeightMap, poiMesh, poiCam.viewDir, poiCam.tangentViewDir, (1.0 /*_HeightStepsMin*/), (1.0 /*_HeightStepsMax*/), (0.005 /*_HeightStrength*/), 0, float4(1,1,0,0).xy, float2((0.0 /*_CurvatureU*/), (0.0 /*_CurvatureV*/)));
				if ((0.0 /*_ParallaxUV*/) == 0)       poiMesh.uv[0] = offset;
				if ((0.0 /*_ParallaxUV*/) == 1)       poiMesh.uv[1] = offset;
				if ((0.0 /*_ParallaxUV*/) == 2)       poiMesh.uv[2] = offset;
				if ((0.0 /*_ParallaxUV*/) == 3)       poiMesh.uv[3] = offset;
				if ((0.0 /*_ParallaxUV*/) == 4)       poiMesh.uv[4] = offset;
				if ((0.0 /*_ParallaxUV*/) == 5)       poiMesh.uv[5] = offset;
				if ((0.0 /*_ParallaxUV*/) == 6)       poiMesh.uv[6] = offset;
				if ((0.0 /*_ParallaxUV*/) == 7)       poiMesh.uv[7] = offset;
				#endif
			}
			#endif
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				float3 directColor = _LightColor0.rgb * saturate(RTWrapFunc(poiLight.nDotL, (0.0 /*_LightingWrappedWrap*/), (1.0 /*_LightingWrappedNormalization*/)));
				float3 indirectColor = 0;
				#ifdef UNITY_PASS_FORWARDBASE
				indirectColor = ShadeSH9_wrapped(lerp(poiMesh.normals[0], poiMesh.normals[1], (0.0 /*_LightingIndirectUsesNormals*/)), (0.0 /*_LightingWrappedWrap*/)) * poiLight.occlusion;
				#endif
				...
				{
					finalWrap = clamp(finalWrap, (0.0 /*_LightingMinLightBrightness*/), (10.0 /*_LightingCap*/));
				}
				else
				{
			...
			void applySubsurfaceScattering(in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiFragData poiFragData)
			{
				...
				float flTDot = pow(saturate(dot(poiCam.viewDir, -vLTLight)), (1.0 /*_SSSSpread*/)) * (0.113 /*_SSSStrength*/);
				#ifdef UNITY_PASS_FORWARDBASE
				...
				#endif
				#if defined(POINT) || defined(SPOT)
				poiLight.finalLightAdd += fLT * poiLight.directColor * float4(0,0.4453062,0.004183171,1) * SSS.rgb * lerp(1, poiFragData.baseColor, (0.0 /*_SSSBaseColorMix*/));
				#endif
				poiLight.finalLightAdd += fLT * poiLight.directColor * float4(0,0.4453062,0.004183171,1) * SSS.rgb * poiLight.attenuation * lerp(1, poiFragData.baseColor, (0.0 /*_SSSBaseColorMix*/));
			}
			#endif
			#ifdef POI_BACKLIGHT
			...
			{
				float3 backlightColor = float4(0.1470273,0.7835379,0.1274377,1).rgb;
				#if defined(PROP_BACKLIGHTCOLORTEX) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				float3 normal = lerp(poiMesh.normals[0], poiMesh.normals[1], (0.484 /*_BacklightNormalStrength*/));
				...
				float backlightLN = dot(normalize(-headDir * (0.0 /*_BacklightViewStrength*/) + poiLight.direction), normal) * 0.5 + 0.5;
				#if defined(POINT) || defined(SPOT)
				...
				#endif
				backlightLN = poiEdgeLinear(backlightLN, (0.576 /*_BacklightBorder*/), (1.0 /*_BacklightBlur*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					mainUV = sharpSample(float4(0.0004882813,0.0009082652,2048,1101), mainUV);
				}
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), (0.3 /*_BumpScale*/));
				#else
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, pow(abs(poiFragData.baseColor), (0.92 /*_MainGamma*/)), hueShiftAlpha.a);
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), - ((0.23 /*_Saturation*/)) * hueShiftAlpha.b);
				...
				#endif
				ApplyLiltoonRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, float4(0,1,0,1), float4(1,1,1,1), rimColorTex, (0.0 /*_RimMainStrength*/), (0.0 /*_RimNormalStrength*/), (0.0 /*_RimDirRange*/), (0.0 /*_RimIndirRange*/), (8.7 /*_RimFresnelPower*/), (1 /*_RimBackfaceMask*/), (0.0 /*_RimDirStrength*/), (0.5 /*_RimBorder*/), (0.65 /*_RimBlur*/), (0.5 /*_RimIndirBorder*/), (0.1 /*_RimIndirBlur*/), (1.0 /*_RimShadowMask*/), (1.0 /*_RimEnableLighting*/), (1.0 /*_RimVRParallaxStrength*/), (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftColorSpace*/), (1.0 /*_RimHueSelectOrShift*/), (0.0 /*_RimHueShiftSpeed*/), (1 /*_RimBlendMode*/));
				#endif
				#endif
				if ((0.0 /*_IgnoreFog*/) == 0)
				{
